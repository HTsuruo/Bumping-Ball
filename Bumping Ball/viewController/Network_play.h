...
@interface Network_play : UIViewController<GKMatchDelegate>{
    ...
    //相手からのボール
    UIImageView * imageV4[NUM4];
    UIImageView * newImageV4[NUM4];
